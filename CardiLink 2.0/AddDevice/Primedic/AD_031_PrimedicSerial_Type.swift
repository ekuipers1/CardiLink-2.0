//
//  AD_031_PrimedicSerial_Type.swift
//  CardiLink 2.0
//
...
struct AD_031_PrimedicSerial_Type: View {
                ...
                VStack(){
                    ...
                    VStack(spacing: 5) {
                        if isTextBEditing {
                            ...
                            TextField("Enter serial number", text: $AEDCode)
                                ...
                                .offset(x: 30)
                            Rectangle()
                                .fill(AEDCode.count < 10 ? Color.colorCardiRed : Color.Calming_Green)
                    ...
                    ZStack {
                        Rectangle()
                            ...
                            .shadow(
                                color: (areTextFieldsEqual && (AEDCodeCheck == "Enter serial number" || AEDCodeCheck.count < 10))
                        ...
                        VStack(spacing: 5) {
                            ...
                            Rectangle()
                                .fill(AEDCodeCheck.count < 10 ? Color.colorCardiRed : (areTextFieldsEqual) ? Color.Calming_Green : Color.colorCardiRed)
    ...
    func checkIfSerialExists(completion: @escaping (Bool) -> Void){
        ...
        let url_defi = myURL! + myDefibrillators + AEDCode
    ...
    func ADNONIOTActivation(completion: @escaping (Bool) -> Void){
        ...
        let url_defi = myURL! + myDefibrillators + AEDCodeCheck + "/start?isnoniot=true"
