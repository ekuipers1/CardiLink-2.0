//
//  ADNKPairingStages.swift
//  CardiLink 2.0
//
//  Created by Erik Kuipers on 16.06.23.
//

import SwiftUI

struct ADNKPairingStages: View {
                    ...
                    VStack(){
                        ...
                        if ADstate == 1 || ADstate == 2 {
                            ...
                            if unableToConnect == true {
                                ...
                                if demoProd == "Demo" || demoProd == "Test" {
                                    ...
                                    Button(action: {
                                        navigationManager.navigateTo(.adnkparingclosecover)
                                    }, label: {
                                        HStack {
                                            Text("Continue")
                                                .fontWeight(.semibold)
                        ...
                        if ADstate == 3 {
                            ...
                            Button(action: {
                                ...
                                navigationManager.push(.adnkparingclosecover)
                            }, label: {
                                HStack {
                                    Text("Next")
                                        .fontWeight(.semibold)
