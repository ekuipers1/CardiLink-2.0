...
struct AED_Red: View {
    ...
    @StateObject var redSearchViewModel = SearchViewModelColorRed()
        ...
        VStack {
            ...
            HStack {
                ...
                Button(action: {
                    ...
                    redSearchViewModel.fetchDataFilter(searchText: searchText, filter: "")
            ...
            if isLoading {
                ...
                List(filteredDefibrillators) { defibrillator in
                    ...
                    .onTapGesture {
                        ...
                        UserDefaults.standard.set(true, forKey: "NavFromRedListView")
    ...
    var filteredDefibrillators: [SearchDefibrillator] {
        if let filter = currentFilter {
            return redSearchViewModel.defibrillators.filter { $0.dashboardState == filter }  // Updated here
        }
        return redSearchViewModel.defibrillators  // Updated here
    }
}
