//
//  DefibrillatorOverviewPhotos.swift
//  CardiLink 2.0
//
...
struct DefibrillatorOverviewPhotos: View {
...
struct ImagePickerNew: UIViewControllerRepresentable {
    ...
    class Coordinator: NSObject, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
        var parent: ImagePickerNew
        init(_ parent: ImagePickerNew) {
            self.parent = parent
        }
    ...
    func updateUIViewController(_ uiViewController: UIImagePickerController, context: UIViewControllerRepresentableContext<ImagePickerNew>) {
    }
}
...
struct ImagePickerGallery: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: UIViewControllerRepresentableContext<ImagePickerGallery>) -> UIImagePickerController {
        let picker = UIImagePickerController()
    ...
    func updateUIViewController(_ uiViewController: UIImagePickerController, context: UIViewControllerRepresentableContext<ImagePickerGallery>) {
    }
}
