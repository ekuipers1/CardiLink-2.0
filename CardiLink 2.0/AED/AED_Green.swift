...
//  CardiLink 2.0
//
//  Created by Erik Kuipers on 29.09.23.
//
...
struct AED_Green: View {
    ...
    @StateObject var greenSearchViewModel = SearchViewModelColorGreen()
        ...
        VStack {
            ...
            HStack {
                ...
                Button(action: {
                    ...
                    greenSearchViewModel.fetchDataFilter(searchText: searchText, filter: "")
                ...
                List(filteredDefibrillators) { defibrillator in
                    VStack(alignment: .leading) {
                        ...
                        .onTapGesture {
                            ...
                            UserDefaults.standard.set(true, forKey: "NavFromGreenListView")
                            LoadMyData()
    ...
    var filteredDefibrillators: [SearchDefibrillator] {
        if let filter = currentFilter {
            return greenSearchViewModel.defibrillators.filter { $0.dashboardState == filter }  // Updated here
        }
        return greenSearchViewModel.defibrillators  // Updated here
    }
