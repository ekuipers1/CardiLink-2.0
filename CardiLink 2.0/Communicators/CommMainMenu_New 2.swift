...
//            .padding(.bottom, 10)
            ...
            ScrollView{
                ...
                LazyVStack(spacing: 15) {
                    ForEach(fetcherForComs.fetchcommData) { mycomms in
                        NavigationLink(
...
//                                            Text(mycomms.datumDescription ?? "..")
                                    ...
                                    }.padding(.horizontal, 55.0)// .padding(35.0)
...
struct CommMainMenu_New_Previews: PreviewProvider {
